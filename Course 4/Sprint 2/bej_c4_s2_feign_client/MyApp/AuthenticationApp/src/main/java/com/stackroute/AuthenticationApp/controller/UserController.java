...
public class UserController {
    ...
    public ResponseEntity<?> addUser1(@RequestBody SignUpData signUpData) throws UserAlreadyExistException
    {
        return new ResponseEntity<>(userService.addUser1(signUpData),HttpStatus.OK);
    }
